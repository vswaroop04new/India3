...
export declare class ClientRequest {
    ...
    abort: () => void;
    send: (withAuth?: boolean, sigExtraTimeMs?: number) => Promise<SenderResponse>;
    private getSignature;
}
export declare function parseParams(params?: RequestParams): Record<string, BasicValue | undefined>;
export {};
